...
public class Indoor{
	Scene IndoorScene,DepartmentScene;
	String username;
	
	public void start(Stage myStage) {
		 GridPane grid2=new GridPane();
		Scene IndoorScene=new Scene(grid2,700,600);
		myStage.setScene(IndoorScene);
		grid2.setPadding(new Insets(10,100,10,40));
		Text a =new Text("<<<--INDOOR SPORTS-->>>");
		a.setFont(Font.font("Tahoma", FontWeight.EXTRA_BOLD, 26));
		 grid2.setAlignment(Pos.BASELINE_CENTER);
	        ...
	        myStage.setTitle("INDOOR PRODUCTS");
	        grid2.setVgap(10);
	        grid2.add(b,7,3);
		...
		CheckBox option1=new CheckBox("Hula Hoop");
		...
		CheckBox option2=new CheckBox("Skipping ropes");
		...
		CheckBox option3=new CheckBox("Table Tennis Set");
		...
		Text a4=new Text("Rs.200");
		a4.setFont(Font.font("Verdana",FontWeight.SEMI_BOLD,FontPosture.REGULAR,15));
		
		
		
		
		CheckBox option5=new CheckBox("Indoor Basketball Set");
